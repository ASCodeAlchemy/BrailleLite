  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-accent text-accent-foreground hover:shadow-hero shadow-lg font-semibold tracking-wide",
        cta: "bg-primary text-primary-foreground hover:bg-primary-dark shadow-lg hover:shadow-xl transform hover:scale-105 transition-spring font-semibold",
        donate: "bg-gradient-accent text-accent-foreground hover:shadow-hero shadow-lg font-semibold tracking-wide border-2 border-accent-dark hover:border-accent",
        minimal: "bg-surface text-surface-foreground hover:bg-subtle shadow-sm hover:shadow-md border border-border",
      },
      size: {
