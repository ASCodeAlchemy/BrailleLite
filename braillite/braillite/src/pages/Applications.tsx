"use client";
import { applications, Application } from "@/data/applicationsData"; // Make sure to export the 'Application' type
...
const ApplicationsPage = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-slate-50 dark:bg-slate-950 overflow-hidden p-4 md:p-6">
      {/* Background Blobs */}
      ...
      <main className="relative z-10 space-y-6">
        {/* Header */}
        <div>
            <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-50">Applications</h1>
